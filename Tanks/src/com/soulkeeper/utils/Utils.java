...
return newImage;
    ...
    public static final Integer[] str2int_arrays(String[] sARrr){
        Integer []result = new Integer[sARrr.length];
        for(int i=0;i<sARrr.length;i++){
            result[i] = Integer.parseInt(sARrr[i]);
        }
            return result;
    }
